...
const Home: FC<Props> = (props) => {
  return (
    <div className="container mx-16 h-screen bg-slate-100">
      ...
      <input name="name" id="name" type="text" className="appearance-none rounded-full nm-inset-slate-100 leading-5 mx-2 px-8 py-4 flex-grow sm:w-1/3" placeholder="John Doe"></input>
      ...
      <div className="space-x-8 my-8 flex">
        ...
        <button className="h-12 px-6 flex justify-center items-center rounded-full nm-concave-slate-100-sm text-slate-600">
